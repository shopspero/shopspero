...
const staffData: StaffInfo[] = [
  ...
  },
  {
    ...
    img: '/images/team/ethan_yang.jpg',
  },
  {
    name: 'Michael Dai',
    ...
    img: '/images/team/michael_dai.jpg',
  },
  {
    name: 'Abi Cho',
  ...
  },
  {
    ...
    bio: "Hi, my name is Haejoo and I’m a second year student at UC Berkeley pursuing social welfare working towards the goal of business marketing. I joined Spero to spread the gospel on campus that speaks to both believers and non believers. My hobbies include vlogging, being with animals, and taking photobooth pictures.",
    img: '/images/team/haejoo_chang.jpg',
  },
  {
    name: 'Ryan Amiri',
  ...
  },
  {
    ...
    img: '/images/team/kay_karsono.jpg',
  },
  {
    name: 'Bella Cha',
    role: 'Clothing Designer',
