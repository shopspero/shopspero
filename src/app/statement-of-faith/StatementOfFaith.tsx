    ...
    <Box>
      ...
      <Container maxWidth={900} p={5}>
        ...
        <Text>
          ...
          mind wholeheartedly to subject itself in all its activities to the
          authority of Scripture complete as the Word of God, standing written
          in the sixty-six books of the Holy Bible, all therein being verbally
          inspired by Almighty God and therefore without error.
        </Text>
        <Heading as="h2" size="lg" pt={5} pb={3}>
          2. There is One True God
        </Heading>
        <Text>
          We believe that there is but one only, the living and true God, and
          that there are three persons in the Godhead, the Father, the Son and
          the Holy Ghost; and that these three are one and the same in
        ...
        <Text>
          ...
          earthly sacrificial mission, He became human by being born of a
          virgin, conceived by the Holy Spirit (Matthew 1:23; Luke 1:31, 35). He
          lived a perfect life, absolutely without sin (Hebrews 7:26; 1 Peter
          2:22). While on earth He worked many miracles through the anointing of
          the Holy Spirit (Acts 2:22, 10:38). In order to restore fallen
          mankind, He died on the cross as a substitute for the sins of every
          person (1 Corinthians 15:3, 2 Corinthians 5:21). He was raised from
          the dead by the supernatural power of God (Matthew 28:6; Luke 24:38, 1
          Corinthians 6:14, 15:4). Since His resurrection He has been exalted,
          and is seated at the right hand of God (Acts 1:9, 11, 2:33;
        ...
        <Text>
          ...
          in our place&mdash;He substituted Himself for us and took what we
          rightly deserved. &ldquo;God made him who had no sin to be sin for us,
          so that in him we might become the righteousness of God&rdquo; (2
          Corinthians 5:21).
        </Text>
        <Heading as="h2" size="lg" pt={5} pb={3}>
        ...
        <Text>
          ...
          hope&mdash;the appearance of the glory of our great God and Savior,
          Jesus Christ.&rdquo; We will be blessed beyond measure when we see
          Christ. The trials of this life will be over, and we will see that
          &ldquo;our present sufferings are not worth comparing with the glory
          that will be revealed in us&rdquo; (Romans 8:18). The bodies of those
          who have died will be raised to be joined with their souls, and then
          the bodies of those believers still living on earth will be changed
          into a body like the Lord&apos;s resurrection body.
        </Text>
      </Container>
    </Box>
  );
